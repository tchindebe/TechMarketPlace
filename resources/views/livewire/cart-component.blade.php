                                            ...
                                            <tr>
                                                ...
                                                <td data-title="Price" class="product-price">
                                                                    <span class="woocommerce-Price-amount amount">
                                                                        <span class="woocommerce-Price-currencySymbol">£</span>{{ number_format($item->quantity * $item->sale_price, 2, ',', ' ') }}
                                                                    </span>
                                                </td>
                                                ...
                                                <td data-title="Total" class="product-subtotal">
                                                    ...
                                                    <form action="{{ route('panier.destroy', $item->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <i title="Remove this item" class="remove" href="{{ route('panier.destroy', $item->id) }}">×</i>
                                                    </form>
