            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                                ...
                                <div class="woocommerce columns-8">
                                    <div class="products">
                                        ...
                                        <div class="product">
                                            ...
                                            <a href="{{ route('product.show', $product->id) }}" class="woocommerce-LoopProduct-link">
                                                ...
                                                <span class="price">
                                                    ...
                                                    <span class="amount">
                                                    @if($product->quantity)
                                                            <p><strong>{{ number_format($product->sale_price, 2, ',', ' ') }} FCFA TTC</strong></p>
                                                        @else
                        ...
                        <div class="section-products-carousel-tabs-wrap">
                            <header class="section-header">
                                ...
                                <ul role="tablist" class="nav justify-content-end">
                                    <li class="nav-item"><a class="nav-link active" href="#tab-59f89f0a815100" data-toggle="tab">Bestsellers</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a815101" data-toggle="tab">Dresses</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a815102" data-toggle="tab">Tops</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a815103" data-toggle="tab">Sweaters</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a815104" data-toggle="tab">Activewear</a></li>
                                </ul>
                            </header>
                            <div class="tab-content">
                                <div id="tab-59f89f0a815100" class="tab-pane active" role="tabpanel">
                                                ...
                                                <div class="products">
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/5.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/12.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/9.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/4.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/16.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/13.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/10.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            ...
                                                            <img src="{{asset('assets/images/products/7.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/8.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            <img src="{{asset('assets/images/products/1.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> </span>
                                                                </ins>
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                            ...
                                                            <img src="{{asset('assets/images/products/14.jpg')}}" width="224" height="197" class="wp-post-image" alt="">
                                                            <span class="price">
                                                                <ins>
                                                                    <span class="amount"> 262.81</span>
                                                                </ins>
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a815101" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a815102" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a815103" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a815104" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;infinite&quot;:false,&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1700,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                    ...
                    <section class="section-products-carousel" id="section-products-carousel-8">
                        <header class="section-header">
                            <h2 class="section-title">Best Value Perfumes & Beauty</h2>
                            <nav class="custom-slick-nav"></nav>
                        </header>
                        <!-- .section-header -->
                    ...
                    <section class="section-products-carousel-tabs">
                        <div class="section-products-carousel-tabs-wrap">
                            <header class="section-header">
                                ...
                                <ul role="tablist" class="nav justify-content-end">
                                    <li class="nav-item"><a class="nav-link active" href="#tab-59f89f0a8a3f50" data-toggle="tab">Bestsellers</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a8a3f51" data-toggle="tab">Treadmills</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a8a3f52" data-toggle="tab">Weights</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a8a3f53" data-toggle="tab">Benches</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a8a3f54" data-toggle="tab">Exercise Bikes</a></li>
                                    <li class="nav-item"><a class="nav-link " href="#tab-59f89f0a8a3f55" data-toggle="tab">Yoga</a></li>
                                </ul>
                            </header>
                            <div class="tab-content">
                                <div id="tab-59f89f0a8a3f50" class="tab-pane active" role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                                    <div class="product">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a8a3f51" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a8a3f52" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a8a3f53" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a8a3f54" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <!-- .tab-pane -->
                                <div id="tab-59f89f0a8a3f55" class="tab-pane " role="tabpanel">
                                    <div class="products-carousel" data-ride="tm-slick-carousel" data-wrap=".products" data-slick="{&quot;slidesToShow&quot;:8,&quot;slidesToScroll&quot;:8,&quot;dots&quot;:true,&quot;arrows&quot;:false,&quot;responsive&quot;:[{&quot;breakpoint&quot;:650,&quot;settings&quot;:{&quot;slidesToShow&quot;:1,&quot;slidesToScroll&quot;:1}},{&quot;breakpoint&quot;:780,&quot;settings&quot;:{&quot;slidesToShow&quot;:3,&quot;slidesToScroll&quot;:3}},{&quot;breakpoint&quot;:1200,&quot;settings&quot;:{&quot;slidesToShow&quot;:4,&quot;slidesToScroll&quot;:4}},{&quot;breakpoint&quot;:1400,&quot;settings&quot;:{&quot;slidesToShow&quot;:6,&quot;slidesToScroll&quot;:6}}]}">
                                        <div class="container-fluid">
                                            <div class="woocommerce columns-8">
                                                <div class="products">
                                ...
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="apple" src="{{asset('assets/images/brands/1.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="bosch" src="{{asset('assets/images/brands/2.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="cannon" src="{{asset('assets/images/brands/3.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="connect" src="{{asset('assets/images/brands/4.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="galaxy" src="{{asset('assets/images/brands/5.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="gopro" src="{{asset('assets/images/brands/6.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="handspot" src="{{asset('assets/images/brands/7.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="kinova" src="{{asset('assets/images/brands/8.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="nespresso" src="{{asset('assets/images/brands/9.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="samsung" src="{{asset('assets/images/brands/10.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="speedway" src="{{asset('assets/images/brands/11.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
                                <div class="item">
                                    <a href="shop.html">
                                        <figure>
                                            ...
                                            <img width="145" height="50" class="img-responsive desaturate" alt="yoko" src="{{asset('assets/images/brands/12.png')}}">
                                        </figure>
                                    </a>
                                </div>
                                <!-- .item -->
