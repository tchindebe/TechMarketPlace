                    ...
                    <div class="dropdown profile-element">
                        <span>
                             @if(Auth::User()->profile->logo)
                                <img src="{{asset('storage') . '/' . Auth::User()->profile->logo}}" style="height: 50px; width: 50px;" alt="Female">
                            @endif
                            @if(Auth::User()->profile->logo == null)
                                <img src="{{asset('assets/clientAsset/plugins/images/users/shop.png')}}" style="height: 50px; width: 50px;" alt="user-img responsive" class="img-circle">
                            @endif
                             </span>
