    ...
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
        <div class="py-4 text-gray-500">
            ...
            <ul class="mt-6">
                ...
                <li class="relative px-6 py-3">
                    @if( Route::currentRouteName() == 'admin.store')
                        <span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
                    @endif
                    <a class="inline-flex items-center w-full text-sm font-semibold {{ Route::currentRouteName()=='admin.store' ? 'text-gray-800' : '' }} transition-colors duration-150 hover:text-gray-800" href="{{ route('admin.store') }}">
                        <svg class="w-5 h-5"
                             aria-hidden="true"
                             fill="none"
                             stroke-linecap="round"
