        ...
        <div class="row animated fadeInRight">
            <div class="col-md-4">
                <div class="ibox float-e-margins">
                    ...
                    <div style="padding: 10%!important; background-color: white;">
                        <div class="ibox-content no-padding border-left-right">
                            @if($profile->logo != null)
                                <img alt="image" class="img-responsive" src="{{asset('storage') . '/' . $profile->logo}}">
                            @endif
                                @if($profile->logo == null)
                                    <img alt="image" class="img-responsive" src="{{asset('assets/clientAsset/plugins/images/users/profile.jpg')}}" >
                                @endif
                        </div>
                        <div class="ibox-content profile-content0">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <div id="animation_box" class="animated">
                                                    <div>
                                                        <form role="form" class="p-5" method="post" action="{{route('user.customers.update', Auth::user()->id)}}" enctype="multipart/form-data">
                                                            @csrf
                                                            ...
                                                            <div class="form-group"><input type="file" placeholder="Add your image profile" name="logo" class="form-control"></div>
                                                            <div class="mt-4">
                                                                <button class="btn btn-sm btn-primary mt-3 m-t-n-xs" type="submit"><strong>Edit my profile</strong></button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
