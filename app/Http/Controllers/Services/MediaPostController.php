...
class MediaPostController extends Controller
{
    ...
    {
        return view('livewire.services.media_video.index');
    }
    ...
    {
        $mediaService = $this->mediaService->create($mediaRequest->all());
        return redirect()->back()->with('success', "the media has been added successfully");
    }
